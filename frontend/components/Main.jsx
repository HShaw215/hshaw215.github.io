        ...
        <div class="main">
            ...
            <div class='text'>
                ...
                <div class="bio">
                    ...
                    <p>
                        My most recent project that I am working on is 
                        <a class='project' href='https://github.com/ConquestIO/Conquest'> Conquest</a>
                        , a test tracking tool used to promote test driven development across teams.
                    </p>
                    <p>
